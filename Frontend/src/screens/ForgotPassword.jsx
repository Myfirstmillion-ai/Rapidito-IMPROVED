        ...
        <div className="w-full h-dvh flex flex-col text-center p-4 pt-6 gap-24">
            ...
            <div className="px-2">
                ...
                <p className="text-sm mt-3 text-zinc-600 text-balance">
                    Ingresa tu correo electrónico registrado para recibir el enlace de restablecimiento de contraseña
                </p>
                <img src={mailImg} alt="Verificar Email" className="h-36 mx-auto my-8" />
